...
const LINKS: { id: PreciosTabId; href: string; label: string; hint: string }[] = [
  { id: "overview", href: "/precios", label: "Resumen", hint: "Los 3 packs principales" },
  { id: "integral", href: "/precios#integral", label: "Integral", hint: "Opciones Web + App" },
  { id: "web", href: "/precios#web", label: "Web", hint: "Opciones de captación" },
  { id: "erp", href: "/precios#erp", label: "App", hint: "Opciones de gestión" },
];
...
export function PreciosSegmentNav({ active, onSelect }: PreciosSegmentNavProps) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200/80 bg-white p-1.5 shadow-sm sm:inline-flex sm:flex-wrap sm:items-center sm:gap-1">
      {LINKS.map((item) => {
