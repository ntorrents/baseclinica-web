  ...
  return (
    <div className="fixed bottom-6 left-6 z-[60] flex items-center gap-3 pointer-events-none">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="pointer-events-auto relative flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_0_20px_rgba(37,211,102,0.4)] transition-colors hover:bg-[#20bd5a]"
      >
        {/* Pulsing effect */}
        <span className="absolute inset-0 rounded-full animate-ping bg-[#25D366] opacity-30" />

        {/* Icon */}
        <svg className="relative z-10 w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
